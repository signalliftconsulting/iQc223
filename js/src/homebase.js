...
function _renderHomeBase() {
  ...
  const _aiSpinner = '<span style="display:inline-block;width:12px;height:12px;border:2px solid rgba(15,118,110,.2);border-top-color:#0f766e;border-radius:50%;animation:spin .8s linear infinite;vertical-align:middle"></span>';
